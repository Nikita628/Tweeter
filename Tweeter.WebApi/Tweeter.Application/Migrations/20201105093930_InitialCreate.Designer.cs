...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tweeter.Application.DbModel.Follow", b =>
                {
            ...
            modelBuilder.Entity("Tweeter.Application.DbModel.HashTag", b =>
                {
            ...
            modelBuilder.Entity("Tweeter.Application.DbModel.Tweet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Tweeter.Application.DbModel.TweetBookmark", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tweeter.Application.DbModel.TweetCommentLike", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tweeter.Application.DbModel.TweetLike", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tweeter.Application.DbModel.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Tweeter.Application.DbModel.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tweeter.Application.DbModel.Tweet", b =>
                {
                    ...
                    b.HasOne("Tweeter.Application.DbModel.Tweet", "RetweetedFrom")
                        .WithMany("Retweets")
            ...
            modelBuilder.Entity("Tweeter.Application.DbModel.TweetCommentLike", b =>
                {
                    b.HasOne("Tweeter.Application.DbModel.TweetComment", "TweetComment")
                        .WithMany()
